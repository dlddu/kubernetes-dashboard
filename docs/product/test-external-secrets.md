...
- **검증 AC**: ES1
- **자동화**: `e2e/external-secrets.spec.ts` (ES1 전용)
...
- **검증 AC**: ES2
- **자동화**: `e2e/external-secrets-summary.spec.ts` (ES2 전용)
...
- **검증 AC**: ES3
- **자동화**: `e2e/external-secrets-card-status.spec.ts` (ES3 전용)
...
- **검증 AC**: ES4
- **자동화**: `e2e/external-secrets-data-states.spec.ts` (ES4 전용)

## 커버리지 요약
- 자동화 연결됨(전용 스펙 1:1): ES1·ES2·ES3·ES4
- 자동화 공백: 없음
