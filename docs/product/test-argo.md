...
- **검증 AC**: AR1
- **자동화**: `e2e/argo-templates.spec.ts` (AR1 전용)
...
- **검증 AC**: AR2, (V4)
- **자동화**: `e2e/argo-submit.spec.ts` (AR2 전용)
...
- **검증 AC**: AR3
- **자동화**: `e2e/argo-workflows.spec.ts` (AR3 전용)
...
- **검증 AC**: AR4, (V6)
- **자동화**: `e2e/argo-workflow-detail.spec.ts` (AR4 전용)
...
- **검증 AC**: AR5, (V4)
- **자동화**: `e2e/argo-workflow-resubmit.spec.ts` (AR5 전용)
...
- **검증 AC**: AR6, (V4)
- **자동화**: `e2e/argo-workflow-delete.spec.ts` (AR6 전용)
...
- **검증 AC**: AR7
- **자동화**: `e2e/argo-data-states.spec.ts` (AR7 전용)

## 커버리지 요약
- 자동화 연결됨(전용 스펙 1:1): AR1·AR2·AR3·AR4·AR5·AR6·AR7
- 자동화 공백: 없음
