// Verifies: FX2 (docs/product/prd-fluxcd.md). Also co-locates FX3 (reconcile) and FX4 (suspend/resume): those specs issue real cluster mutations to dashboard-test Kustomizations and MUST run in the same file as the FX2 list reader so Playwright serializes them (workers:4 parallelizes across files, causing shared-kind-cluster races — see reconcile task rct_20260712-0001).
...
// ===========================================================================
// FX3 — Reconcile (co-located from former e2e/fluxcd-reconcile.spec.ts)
// ===========================================================================
...
// ===========================================================================
// FX4 — Kustomization Suspend/Resume (co-located from former e2e/fluxcd-suspend-resume.spec.ts)
// ===========================================================================
