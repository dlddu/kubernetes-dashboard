// Verifies: docs/product/test-pods.md#시나리오 1 (파드 목록과 카드 정보 표시) — sole dedicated e2e spec for this scenario.
// AC: PD1 (docs/product/prd-pods.md). PD1 is covered by two scenario-dedicated specs;
//     namespace scoping (test-pods.md#시나리오 2) lives in e2e/pods-namespace-scope.spec.ts.
